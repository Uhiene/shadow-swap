...
export interface ERC20ToERC7984WrapperInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ERC20ToERC7984Wrapper extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20ToERC7984Wrapper;
  waitForDeployment(): Promise<this>;

  interface: ERC20ToERC7984WrapperInterface;
