...
export interface IERC20ToERC7984WrapperInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IERC20ToERC7984Wrapper extends BaseContract {
  connect(runner?: ContractRunner | null): IERC20ToERC7984Wrapper;
  waitForDeployment(): Promise<this>;

  interface: IERC20ToERC7984WrapperInterface;
